...
{
    public partial class FormAddExport : Form, IAddExportView
    {
        ...
        public event EventHandler AddExport;
        ...
        public Guna2ComboBox Guna2ComboBoxReason { get { return guna2ComboBox1; } }
        ...
        public Guna2Button Guna2GradientButtonAddProduct { get { return btnAdd ; } }

        public FormAddExport()
        {
            InitializeComponent();
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            {
                AddExport?.Invoke(this, EventArgs.Empty);
