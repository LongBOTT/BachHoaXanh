...
{
    public partial class ImportControl : UserControl, IImportView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            btnDetail.Click += delegate
            {
                ...
                {
                    MessageDialog.Show(MiniSupermarketApp.menu, "Vui lòng chọn phiếu nhập cần xem chi tiết!", "Lỗi", MessageDialogButtons.OK, MessageDialogIcon.Error);
                }
            };
