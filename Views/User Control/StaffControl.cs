    ...
    public partial class StaffControl : UserControl, IStaffView
    {
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            btnDetail.Click += delegate
            {
                ...
                {
                    MessageDialog.Show(MiniSupermarketApp.menu, "Vui lòng chọn nhân viên cần xem chi tiết!", "Lỗi", MessageDialogButtons.OK, MessageDialogIcon.Error);
                }
            };
            ...
            btnEdit.Click += delegate
            {
                ...
                {
                    MessageDialog.Show(MiniSupermarketApp.menu, "Vui lòng chọn nhân viên cần sửa!", "Lỗi", MessageDialogButtons.OK, MessageDialogIcon.Error);
                }
            };
            btnDelete.Click += delegate
            {
                ...
                {
                    MessageDialog.Show(MiniSupermarketApp.menu, "Vui lòng chọn nhân viên cần xoá!", "Lỗi", MessageDialogButtons.OK, MessageDialogIcon.Error);
                }
            };
        }
