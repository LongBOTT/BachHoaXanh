...
{
    public partial class BillControl : UserControl, IBillView
    {
        public BillControl()
        {
            InitializeComponent();
        ...
        private void AssociateAndRaiseViewEvents()
        {
            ...
            btnDetail.Click += delegate
            {
                ...
                {
                    MessageDialog.Show(MiniSupermarketApp.menu, "Vui lòng chọn hoá đơn cần xem chi tiết!", "Lỗi", MessageDialogButtons.OK, MessageDialogIcon.Error);
                }
            };
        }
